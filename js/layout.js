    ...
    wrap.innerHTML += `
        <div style="width:100%;">
            <div style="width: 100%; margin: 0 auto; padding: 2.5rem 1.75rem; box-sizing: border-box; background-color: #FFF; font-size: 1rem; font-weight: 400; text-align: center; line-height: 1.75; color: #333; font-family: 'Roboto', 'Noto Sans KR', '맑은고딕', Malgun Gothic, '돋움', Dotum, Helvetica, 'Apple SD Gothic Neo', Sans-serif;">
                ...
                <div style="width: 100%; max-width: 18.75rem; margin: 0 auto; margin-top: 0.75rem; padding-right: 2rem;">
                ...
                <a href="https://partywon.vercel.app/p/${"aw3aafs3j"}" target="_blank" style="display: block; width: 100%; max-width: 20rem; height: 3rem; margin: 0 auto; margin-top: 1.25rem; line-height: 3rem; text-align: center; border-radius: 0.5rem; background-color: #FF6E40; color: #FFF; text-decoration: none;">링크 바로가기</a>
